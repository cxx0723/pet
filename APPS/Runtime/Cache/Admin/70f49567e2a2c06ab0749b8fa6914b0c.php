...
<head>
	...
	<link href="/pet/Public/css/user.css" type="text/css" rel="stylesheet" />
	<title>login</title>
</head>
<body>
	...
	<div class="login-box">
		<form action="<?php echo U('Login/index');?>" method="post">
			...
			<div class="login-btn">
				...
				<button type="submit" disabled="true" id="btn">登录</button>
			</div>
		</form>
	</div>
</body>
<script src="/pet/Public/js/login.js"></script>
...
<script>
	...
	$(document).on('mouseup','#sp',function(){
		a = $("p").text();
		if (a == "松开验证") {
