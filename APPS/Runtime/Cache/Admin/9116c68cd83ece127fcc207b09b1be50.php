          ...
          <form class="am-form tjlanmu">
            ...
            <div class="am-form-group">
              ...
              <div class="you">
                ...
                <select>
                  <option value="0">顶级分类</option>
                  <?php if(is_array($types)): foreach($types as $key=>$vo): ?><option value="<?php echo ($vo["tid"]); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            <div class="am-form-group am-cf">
        ...
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
          ...
          <tbody>
            ...
            <?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><a href="#"><?php echo ($vo["tname"]); ?></a></td>
              <td><?php echo ($vo["tnum"]); ?></td>
              <td class="am-hide-sm-only">
                  <?php if($id < 5 ): ?>value1
                    <?php else: ?> value2<?php endif; ?>
              </td>
              ...
              <td><i style="margin-left:30px">├─  </i><a href="#">二级分类</a></td>
              <td>default</td>
